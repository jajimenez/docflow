...
- Airflow DAG `ingest_azure_devops_wikis` to ingest pages from Azure DevOps wikis on a daily schedule.
...
- Vector embedding generation using Ollama (`nomic-embed-text:v1.5` model).
